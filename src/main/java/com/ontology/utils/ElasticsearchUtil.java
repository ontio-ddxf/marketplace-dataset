...
//searchRequestBuilder.setQuery(QueryBuilders.matchAllQuery());
        ...
        if (searchResponse.status().getStatus() == 200) {
            // 解析对象
            List<Map<String, Object>> sourceList = setSourceResult(searchResponse, highlightField);
...
//遍历 高亮结果集，覆盖 正常结果集
    ...
    private static List<Map<String, Object>> setSourceResult(SearchResponse searchResponse, String highlightField) {
        List<Map<String, Object>> sourceList = new ArrayList<Map<String, Object>>();
        StringBuffer stringBuffer = new StringBuffer();
...
//                System.out.println("遍历 高亮结果集，覆盖 正常结果集" + searchHit.getSourceAsMap());
                ...
                if (text != null) {
                    ...
                    //遍历 高亮结果集，覆盖 正常结果集
                    source.put(highlightField, stringBuffer.toString());
                }
            }
